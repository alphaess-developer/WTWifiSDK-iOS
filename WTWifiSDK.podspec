#
#  Be sure to run `pod spec lint WTWifiSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Cavan" => "cavan@alpha-ess.com" }
  # Or just: spec.author    = "Cavan"
  # spec.authors            = { "Cavan" => "cavan@alpha-ess.com" }
  # spec.social_media_url   = "https://twitter.com/Cavan"
  ...
  spec.frameworks = "SystemConfiguration", "CoreData", "CFNetwork"
  ...
  spec.module_map = 'WTWifiSDK.modulemap'
